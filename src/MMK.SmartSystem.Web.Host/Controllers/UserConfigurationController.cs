...
using MMK.SmartSystem.Controllers;

// For more information on enabling MVC for empty projects, visit https://go.microsoft.com/fwlink/?LinkID=397860

namespace MMK.SmartSystem.Web.Host.Controllers
{
    public class UserConfigurationController : AbpController
    {
        AbpCustomConfigurationBuilder abpCustomConfigurationBuilder;
        public UserConfigurationController(AbpCustomConfigurationBuilder _abpCustomConfigurationBuilder)
        {
            abpCustomConfigurationBuilder = _abpCustomConfigurationBuilder;
        }

        public async Task<JsonResult> GetAll()
        {
            var userConfig = await abpCustomConfigurationBuilder.GetAll();
            return Json(userConfig);
        }
    }

    public class AbpCustomConfigurationBuilder : ITransientDependency
    {
        ...
        public AbpCustomConfigurationBuilder(
