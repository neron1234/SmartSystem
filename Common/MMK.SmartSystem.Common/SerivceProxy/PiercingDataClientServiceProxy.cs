...
namespace MMK.SmartSystem.Common.SerivceProxy
{
    public partial interface IPiercingDataClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<RequestResult<PagedResultDtoOfPiercingDataDto>> GetAllAsync(int? skipCount, int? maxResultCount);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<RequestResult<PagedResultDtoOfPiercingDataDto>> GetAllAsync(int? skipCount, int? maxResultCount, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class PiercingDataClientServiceProxy
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<RequestResult<PagedResultDtoOfPiercingDataDto>> GetAllAsync(int? skipCount, int? maxResultCount)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<RequestResult<PagedResultDtoOfPiercingDataDto>> GetAllAsync(int? skipCount, int? maxResultCount, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
