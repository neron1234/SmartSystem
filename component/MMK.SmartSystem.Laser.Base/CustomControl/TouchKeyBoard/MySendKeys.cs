...
namespace MMK.SmartSystem.Laser.Base.CustomControl
{
    ...
    */
    ...
    public static class Mouse
    {
        ...
        public static void Down(MouseButton mouseButton)
        {
            switch (mouseButton)
            {
                case MouseButton.Left:
                    SendMouseInput(0, 0, 0, MySendKeys.SendMouseInputFlags.LeftDown);
                    break;
                case MouseButton.Right:
                    SendMouseInput(0, 0, 0, MySendKeys.SendMouseInputFlags.RightDown);
                    break;
                case MouseButton.Middle:
                    SendMouseInput(0, 0, 0, MySendKeys.SendMouseInputFlags.MiddleDown);
                    break;
                case MouseButton.XButton1:
                    SendMouseInput(0, 0, MySendKeys.XButton1, MySendKeys.SendMouseInputFlags.XDown);
                    break;
                case MouseButton.XButton2:
                    SendMouseInput(0, 0, MySendKeys.XButton2, MySendKeys.SendMouseInputFlags.XDown);
                    break;
                default:
        ...
        {
            SendMouseInput(point.X, point.Y, 0, MySendKeys.SendMouseInputFlags.Move | MySendKeys.SendMouseInputFlags.Absolute);
        }
        ...
        public static void Reset()
        {
            ...
            {
                SendMouseInput(0, 0, 0, MySendKeys.SendMouseInputFlags.LeftUp);
            }

            if (System.Windows.Input.Mouse.MiddleButton == MouseButtonState.Pressed)
            {
                SendMouseInput(0, 0, 0, MySendKeys.SendMouseInputFlags.MiddleUp);
            }

            if (System.Windows.Input.Mouse.RightButton == MouseButtonState.Pressed)
            {
                SendMouseInput(0, 0, 0, MySendKeys.SendMouseInputFlags.RightUp);
            }

            if (System.Windows.Input.Mouse.XButton1 == MouseButtonState.Pressed)
            {
                SendMouseInput(0, 0, MySendKeys.XButton1, MySendKeys.SendMouseInputFlags.XUp);
            }

            if (System.Windows.Input.Mouse.XButton2 == MouseButtonState.Pressed)
            {
                SendMouseInput(0, 0, MySendKeys.XButton2, MySendKeys.SendMouseInputFlags.XUp);
            }
        }
        ...
        {
            int amount = (int)(MySendKeys.WheelDelta * lines);

            SendMouseInput(0, 0, amount, MySendKeys.SendMouseInputFlags.Wheel);
        }
