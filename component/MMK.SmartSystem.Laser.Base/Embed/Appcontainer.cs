...
namespace MMK.SmartSystem.Laser.Base.Embed
{
    public class AppContainer : ContentControl
    {
        ...
        public AppContainer()
        {
            ...
            res.Source = new Uri("pack://application:,,,/MMK.SmartSystem.Laser.Base;component/Embed/AppContainer.xaml");
        ...
        public override void OnApplyTemplate()
        {
            ...
            _winFormHost = GetTemplateChild("PART_Laser") as WindowsFormsHost;
